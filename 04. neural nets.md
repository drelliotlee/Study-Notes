...
- forward feed (an already trained network) 
	- ![591](./04.%20neural%20nets-1774950649906.webp)
	- ![350](./image-334_study_pers.webp) ← 1 layer
	- ![277](./image-337_study_pers.webp)← cost of 1 training example
- training a network
	- ![214](./image-339_study_pers.png)← total cost is just a function of  j (the space of all possible weights & biases). how to minimize it wrt j? find its negative gradient, take a small step, repeat. AKA backprop
	...
	- ![350](./image-345_study_pers.png)
	- the cost is just the composition of 3 functions→  the chain rule
	- ![350](./image-346_study_pers.png)

# CNNs
- pure math defn
	- ![300](./04.%20neural%20nets-1774959341898.webp)
	- conv(n,m) = n+m-1
- key computation
	- ![572](./04.%20neural%20nets-1774952251278.webp)
...
- forward feed
	- ![619](./04.%20neural%20nets-1774954424911.webp)
...
# RNNs 
- feed-forward
	- ![234](./04.%20neural%20nets-1774958943835.webp)
	- ![659](./04.%20neural%20nets-1774958969724.webp)
	- single hidden state h,
	- E = embedding matrix
	- V, U, W = translating between new word, hidden states, prev hidden states, and output pred
- training network
	- ![300](./04.%20neural%20nets-1774959123915.webp)
